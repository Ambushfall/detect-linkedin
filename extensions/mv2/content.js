/**
 * Content script for LinkedIn Extension Detector (MV2)
 *
 * Receives script URLs from the background page, fetches the
 * script body (leveraging browser cache), and scans it for
 * extension-fingerprinting patterns.
 */
